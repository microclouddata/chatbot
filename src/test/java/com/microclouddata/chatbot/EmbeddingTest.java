...
//
//        System.out.println("vector Dimensions：" + embed.content().vector().length);
...
//        //并使用默认的文档解析器对文档进行解析
//        Document document1 = FileSystemDocumentLoader.loadDocument("d:/knowledge/about-us.md");
//        Document document2 = FileSystemDocumentLoader.loadDocument("d:/knowledge/services.md");
//        Document document3 = FileSystemDocumentLoader.loadDocument("d:/knowledge/contact.md");
